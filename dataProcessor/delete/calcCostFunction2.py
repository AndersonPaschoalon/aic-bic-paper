...
PATH_DIR =  '/home/anderson/ProjetoMestrado/Tests/PrototypeDataProcessor/plots/skype/'
...
np.savetxt(PATH_DIR + 'costFunction2.dat', costFunction, delimiter=", ", fmt='%s', header='StochasticModel, CostFunction')
print("costFunction2=", costFunction)
